...
export function PropertiesGate({
  ...
  return (
    <SiteContextProvider value={formContext}>
      <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(300px,400px)", gap: 40, alignItems: "start" }}>
        <div>
          ...
          {/* Blurred placeholder cards — desire, not data. */}
