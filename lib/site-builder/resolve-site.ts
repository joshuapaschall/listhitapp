...
// Client-safe pure transforms live in theme-merge.ts (no server imports). Re-export
// here so existing server callers keep importing them from resolve-site unchanged.
export { mergeThemeIntoRoot, injectNavIdentity } from "./theme-merge"
